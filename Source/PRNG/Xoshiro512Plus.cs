		...
		public override void Reseed()
		{
			using (var rng = RandomNumberGenerator.Create())
			{
				...
				this.SetSeed(
					...
					seed5: BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(32)),
					seed6: BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(40)),
					seed7: BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(48)),
					seed8: BinaryPrimitives.ReadUInt64LittleEndian(span.Slice(56)));
#else
				...
				this.SetSeed(
					...
					seed5: BinaryConverter.ToUInt64(bytes, 32),
					seed6: BinaryConverter.ToUInt64(bytes, 40),
					seed7: BinaryConverter.ToUInt64(bytes, 48),
					seed8: BinaryConverter.ToUInt64(bytes, 56));
#endif
			}
		}
