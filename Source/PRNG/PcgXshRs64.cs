...
namespace Litdex.Random.PRNG
{
	...
	/// </remarks>
	public class PcgXshRs64 : Random64
	{
		#region Member
		...
		/// <summary>
		///	Create an instance of <see cref="PcgXshRs64"/> object.
		/// </summary>
		public PcgXshRs64() : this(UInt128.Zero, UInt128.Zero)
		{
		...
		///	Increment step.
		///	</param>
		public PcgXshRs64(UInt128 seed, UInt128 increment)
		{
		...
		protected override ulong Next()
		{
			...
			var rot = (int)(oldState >> 124);
			return (ulong)(oldState ^ (oldState >> 43)) >> (45 + rot);
		}
		...
		public override void Reseed()
		{
			using (var random = RandomNumberGenerator.Create())
			{
				...
				this.SetSeed(
					seed: BinaryPrimitives.ReadUInt128LittleEndian(data),
					increment: BinaryPrimitives.ReadUInt128LittleEndian(data.Slice(16)));
			}
		}
