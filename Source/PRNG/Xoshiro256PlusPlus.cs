...
namespace Litdex.Random.PRNG
{
	...
	public class Xoshiro256PlusPlus : Xoshiro256Plus
	{
		...
		///	Fourth RNG seed.
		/// </param>
		public Xoshiro256PlusPlus(ulong seed1 = 0, ulong seed2 = 0, ulong seed3 = 0, ulong seed4 = 0) : base(seed1, seed2, seed3, seed4)
		{
		...
		{
			var result = (this._State[0] + this._State[3]).RotateLeft(23) + this._State[0];
