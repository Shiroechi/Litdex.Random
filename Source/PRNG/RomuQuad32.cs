...
namespace Litdex.Random.PRNG
{
	...
	public class RomuQuad32 : Random32
	{
		...
		protected override uint Next()
		{
			...
			this._State[1] = zp + wp.RotateLeft(26); // b-rotl, c-add
			this._State[2] = yp - xp; // d-sub
			this._State[3] = yp + wp; // e-add
			this._State[3] = this._State[3].RotateLeft(9); // f-rotl
			return xp;
		}
		...
		public override void Reseed()
		{
			using (var rng = RandomNumberGenerator.Create())
			{
				...
				this.SetSeed(
					...
					seed4: BinaryPrimitives.ReadUInt32LittleEndian(span.Slice(12)));
#else
				...
				this.SetSeed(
					...
					seed4: BinaryConverter.ToUInt32(bytes, 12));
#endif
			}
		}
